...
class AdminUserAccount extends Component<{}, UserDetailsList> {
            ...
            <>
                <div className="flex justify-center items-center p-5 w-full mx-auto font-poppins">
                    <div className="flex flex-col justify-center items-center px-10 py-2 gap-5 w-full rounded-xl">
                        ...
                        {/*First Div*/}
                        <div
                            className="grid grid-cols-1 sm:grid-cols-2 gap-10 p-5 2xl:p-10 bg-white shadow-lg rounded-xl w-full">

                            {/*first grid item*/}
                            <div className="flex justify-center items-center bg-white rounded-xl p-2 w-full">
