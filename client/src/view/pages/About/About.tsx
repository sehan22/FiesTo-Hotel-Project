    ...
    render() {
        return (
            <>
                ...
                {/*second div*/}
                <div className="hidden flex justify-center items-center mt-[120px] gap-2 mb-[120px]">
                ...
                <div className="flex items-center justify-center mx-auto">
                    ...
                    <div className="grid-cols-1 gap-2 md:gap-5 p-5">
                ...
                {/*third div*/}
                <div
                    className="hidden flex justify-center items-center mt-[120px] gap-2 mb-[120px] font-poppins text-quinary text-normal">
