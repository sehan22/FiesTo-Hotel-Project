    ...
    render() {
        return (
            <>
                ...
                {/*first div*/}
                <div
                    className="flex justify-center items-center mx-auto mb-[60px] md:mb-[120px] mt-[60px] mt:mb-[120px]">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-5 p-5">

                        <div className="md:flex justify-center item center gap-2 hidden">
                            <img className='min-w-[300px] max-w-[500px] object-cover' src={FirstDivImg} alt=""/>
                        </div>

                        <div className="flex flex-col justify-center item center gap-2 order-1">
                            ...
                            <p className="max-w-[600px] font-poppins text-smaller md:text-normal mt-10 text-senary leading-8">
                            ...
                            <button
                                className="max-w-[250px] bg-tertiary transition-all hover:bg-secondary text-smaller text-white py-4 px-6 rounded mt-10 animate-pulse hover:animate-none">
                                BOOK YOUR ROOM NOW
                            </button>
                        </div>
                ...
                {/*second div*/}
                <div className="flex items-center justify-center mx-auto mb-[60px] md:mb-[120px]">

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-5 p-5">

                        <div
                            className="flex flex-col justify-center gap-5 items-start bg-white font-poppins p-10 hover:shadow-sm rounded-lg hover:transition-all">
                            <h1 className="text-topictwo text-quinary font-semibold">Our Story</h1>
                            <p className="text-normal text-senary md:max-w-96">
                ...
                {/*third div*/}
                <div
                    className="text-center p-5 mt-[120px] gap-2 mb-[120px] font-poppins text-quinary text-normal">
