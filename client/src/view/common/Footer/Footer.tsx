    ...
    render() {
        return (
            <>
                ...
                <div className="flex justify-center items-center mx-auto bg-gradient-to-t from-black to-primary">
                    <div className="grid-cols-2 gap-2 p-5 text-white">

                        <div className="flex flex-col items-start justify-center p-5 gap-3">
                            <h1 className="text-secondary">Fiesto Hotel & Restaurant</h1>
                            <p className="max-w-[345px] sm:max-w-[185px]">
